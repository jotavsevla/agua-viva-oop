...
class ApiContractDriftTest {
    ...
    void deveManterOpenApiAlinhadaComEndpointsOperacionaisAtivosNoServidor() throws Exception {
        ...
        assertAll(
                () -> assertTrue(
                        apiServer.contains("server.createContext(\"/api/pedidos\""),
                        "ApiServer deve registrar /api/pedidos"),
                () -> assertTrue(
                        apiServer.contains("server.createContext(\"/api/entregadores\""),
                        "ApiServer deve registrar /api/entregadores"),
                () -> assertTrue(
                        apiServer.contains("server.createContext(\"/api/operacao\""),
                        "ApiServer deve registrar /api/operacao"),
                () -> assertTrue(
                ...
                () -> assertTrue(
                        ...
                        "OpenAPI deve expor /api/pedidos/{pedidoId}/execucao"),
                () -> assertTrue(
                        openApi.contains("/api/entregadores/{entregadorId}/roteiro:"),
                        "OpenAPI deve expor /api/entregadores/{entregadorId}/roteiro"),
                () -> assertTrue(openApi.contains("/api/operacao/painel:"), "OpenAPI deve expor /api/operacao/painel"),
                () -> assertTrue(
                        openApi.contains("/api/operacao/eventos:"), "OpenAPI deve expor /api/operacao/eventos"),
                ...
                () -> assertTrue(
                        ...
                        "OpenAPI deve expor /api/operacao/replanejamento/jobs/{jobId}"),
                () -> assertTrue(
                        openApi.contains("/api/operacao/rotas/prontas/iniciar:"),
                        "OpenAPI deve expor /api/operacao/rotas/prontas/iniciar"),
                () -> assertTrue(
                        openApi.contains("/api/replanejamento/run:"), "OpenAPI deve expor /api/replanejamento/run"),
                () -> assertTrue(
