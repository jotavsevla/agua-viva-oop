...
public final class EventoOperacionalRepository {
    ...
    public void lockPorExternalEventId(Connection conn, String externalEventId) {
        try {
            ...
            throw new DatabaseException("Falha ao aplicar lock por external_event_id", e);
        }
    }
    ...
    public Optional<RegistroExistente> buscarPorExternalEventId(Connection conn, String externalEventId) {
        try {
            ...
            throw new DatabaseException("Falha ao buscar evento operacional por external_event_id", e);
        }
    }
    ...
    public void inserirRegistro(
        ...
        try {
            ...
            throw new DatabaseException("Falha ao inserir registro operacional idempotente", e);
        }
    }
    ...
    public boolean hasColumn(Connection conn, String table, String column) {
        try {
    ...
    public void assertSchema(Connection conn) {
